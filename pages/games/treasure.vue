<template>
	<view>
		...
		<cover-view v-if="statuShow" style="position: absolute;top: 0; left: 0;display: flex;flex-direction: column;align-items: center;">
			...
			<view class="uni-issue">
				<view class="issue-number" v-for="(item,index) in lastFullExpectArr" :key="index" :class="index == 0?'':'uni-move-img'">
					<image class="img" :src="'../../static/games/treasure/img_q'+item+'1@2x.png'"  mode=""></image>
				</view>
				<view class="issue-number" style="margin-left: -10rpx;">
					<image class="img" src="../../static/games/treasure/img_qi1@2x.png" mode=""></image>
				</view>
			</view>
			<view class="uni-issue-content">
				<view class="issue" v-for="(item,index) in lottery_number" :key="index">
					<image class="img" v-if="index<4" :src="'../../static/games/treasure/img_h'+item+'@2x.png'" mode=""></image>
					<image class="img" v-if="index==4" :src="'../../static/games/treasure/img_r'+item+'@2x.png'" mode=""></image>
				</view>
			</view>
			<view class="uni-result" >
				<image v-if="lottery_number[4]%2 == 1" style="width: 100%;height: 100%;" src="../../static/games/treasure/img_hd@3x.png"  mode=""></image>
				<image v-else style="width: 100%;height: 100%;" src="../../static/games/treasure/img_hs@3x.png" mode=""></image>
			</view>
			...
			<view class="uni-btn-content">
				<view class="btn" @tap="goGameShow(1)">
					<image style="width: 100%;height: 100%;" src="../../static/games/treasure/icon_hyxjl@2x.png" mode=""></image>
				</view>
				<view class="btn" @tap="goLotteryHistory()">
					<image style="width: 100%;height: 100%;" src="../../static/games/treasure/icon_hkjls@2x.png" mode=""></image>
				</view>
			</view>
			<view class="uni-btn-submit" @tap="open">
				<image v-if="this.$store.state.is_beeting" style="width: 100%;height: 100%;" src="../../static/games/treasure/icon_htz@2x.png" mode=""></image>
				<image v-else style="width: 100%;height: 100%;" src="../../static/games/treasure/icon_htz1@2x.png" mode=""></image>
			</view>
			<uni-popup ref="popup" type="center">
				<view class="uni-popup-content">
					<view class="btn-result">
						<view class="btn-top" style="position: relative;" @tap="selected_number(0)">
							<image v-if="btnImg == 0" class="img" src="../../static/games/treasure/icon_hbtd2@2x.png" mode=""></image>
							<image v-else class="img" src="../../static/games/treasure/icon_hbtd1@2x.png" mode=""></image>
							<text class="rate-text">赔率：{{oneRate}}</text>
						</view>
						<view class="btn-top" style="position: relative;" @tap="selected_number(1)">
							<image v-if="btnImg == 1" class="img" src="../../static/games/treasure/icon_hbts2@2x.png" mode=""></image>
							<image v-else class="img" src="../../static/games/treasure/icon_hbts1@2x.png" mode=""></image>
					...
					<view class="btn-result" style="margin-top: 55rpx;">
						...
						<view class="btn-bottom" @tap="bettings">
							<image class="img" src="../../static/games/treasure/icon_qd1@2x.png" mode=""></image>
						</view>
					</view>
				</view>
			</uni-popup>
		...
		<cover-view v-else style="position: absolute;top: 0; left: 0;display: flex;flex-direction: column;align-items: center;">
			<uni-nav :fixed="true" left-icon="treasure" right-icon="treasure2"  title="投注提醒"></uni-nav>
			<view class="uni-remind-content">
				<image class="img" src="../../static/games/treasure/img_tz1@2x.png" mode=""></image>
			</view>
			...
			<view class="uni-remind-btn-content">
				...
				<view class="btn"  @tap="goon">
					<image class="img"  src="../../static/games/treasure/icon_hjxtz@2x.png" mode=""></image>
				</view>
			</view>
		</cover-view>
	...
	export default {
		...
		methods:{
			...
			initCanvas(middle) {
				...
				_this.ctx.drawImage('../../static/games/treasure/img_hbg@3x.png', 0, 0, _this.screenWidth, _this.screenHeight);
			...
			gameShows(){
				uni.navigateTo({
					url:"./game_shows?statusShow=1&id="+this.gameid
				})
			},
			goGameShow(index){
				uni.navigateTo({
...
<style lang="scss" scoped>
	...
	.uni-popup-content{
		width:540rpx;
		height:614rpx;
		background:rgba(248,248,248,1) url(../../static/games/treasure/img_hbgtc@2x.png) no-repeat center center;
		border-radius:10rpx;
		display: flex;
